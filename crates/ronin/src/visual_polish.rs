...
pub fn empty_state(kind: EmptyStateKind) -> EmptyStateContent {
    match kind {
        EmptyStateKind::NoThreads => EmptyStateContent {
            ...
            body: "New chats show up in the sidebar.",
        ...
        EmptyStateKind::NoArtifacts => EmptyStateContent {
            ...
            body: "Saved replies show up here.",
            action_hint: Some("Save a reply as an artifact."),
        },
        EmptyStateKind::NoMemories => EmptyStateContent {
            icon: "◎",
            title: "No memories yet",
            body: "Saved facts from chats show up here.",
            action_hint: Some("Save a memory from a reply."),
        },
        EmptyStateKind::NoSearchResults => EmptyStateContent {
            icon: "⌕",
            title: "No results",
            body: "Nothing matched this search.",
            action_hint: Some("Try a shorter query."),
        },
        EmptyStateKind::OllamaOffline => EmptyStateContent {
            icon: "⚠",
            title: "Ollama is not running",
            body: "Ronin cannot reach the local Ollama server.",
            action_hint: Some("Start Ollama or pick a cloud model in settings."),
        },
        EmptyStateKind::NoModelsInstalled => EmptyStateContent {
            icon: "◻",
            title: "No models installed",
            body: "Ollama has no models to chat with.",
